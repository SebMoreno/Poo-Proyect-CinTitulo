...
public class RegistroPelicula {
    ...
    public static void writeTxt() {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("src/temp/peliculas.txt"));) {
    ...
    public static void readTxt() {
        try (BufferedReader br = new BufferedReader(new FileReader("src/temp/peliculas.txt"));) {
            String line;
            do {
                line = br.readLine();
                String[] datos = line.split(" ");
                String[] aux = {datos[1], datos[2], datos[3]};
